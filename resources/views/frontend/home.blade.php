        ...
        <div class="sp-mobile-menu" id="spMobileMenu">
            <div class="container">
                ...
                <div class="sp-mobile-nav-actions">
                    @auth
                        <a href="{{ route('backend.admin.dashboard') }}" class="sp-btn-mobile-cta">
                            <i class="fas fa-gauge-high me-1"></i> Dashboard
                        </a>
                        <a href="{{ route('logout') }}" class="sp-btn-mobile-login">
                            <i class="fas fa-arrow-right-from-bracket me-1"></i> Logout
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="sp-btn-mobile-login">
                            <i class="fas fa-user-circle me-1"></i> Sign In
                        </a>
                        <a href="{{ route('signup') }}" class="sp-btn-mobile-cta">
