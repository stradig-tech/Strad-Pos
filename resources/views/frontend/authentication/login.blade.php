    ...
    <section class="ds-split-auth-container">
        <div class="ds-auth-left" style="justify-content: flex-start; padding-top: 5rem;">
            ...
            <div class="image-content text-center mt-4">
                <img src="{{ asset('assets/images/authentication/login.png') }}" alt="Login" style="max-width: 90%; height: auto;">
            </div>
        </div>
            ...
            <div class="ds-auth-form-container">
                ...
                <form action="{{ route('login') }}" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('forget.password') }}" style="font-size: 0.85rem; color: #4F46E5; text-decoration: none;">Forgot password?</a>
                    </div>
                ...
                <div class="text-center mt-3" style="font-size: 0.9rem; color: #64748B;">
                    Don't have an account ? <a href="{{ route('signup') }}" style="color: #4F46E5; font-weight: 600; text-decoration: none;">Sign up</a>
                </div>
            </div>
        </div>
    </section>
