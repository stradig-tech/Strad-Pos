    ...
    <div class="col-8 col-sm-9 col-md-10">
        <div class="tab-content" id="vert-tabs-tabContent">
            ...
            <div class="tab-pane fade {{ @$_GET['active-tab'] == 'website-info' ? 'active show' : '' }}" id="tabs-1"
                ...
                <form action="{{ route('backend.admin.settings.website.info.update') }}" method="post" class="ds-settings-card">
                    @csrf
            ...
            <div class="tab-pane fade {{ @$_GET['active-tab'] == 'contacts' ? 'active show' : '' }}" id="tabs-2"
                ...
                <form action="{{ route('backend.admin.settings.website.contacts.update') }}" method="post" class="ds-settings-card">
                    @csrf
                    <div class="ds-settings-card-header">
                        <h5>
            ...
            <div class="tab-pane fade {{ @$_GET['active-tab'] == 'social-links' ? 'active show' : '' }}"
                ...
                <form action="{{ route('backend.admin.settings.website.social.link.update') }}" method="post" class="ds-settings-card">
                    @csrf
                    <div class="ds-settings-card-header">
                        <h5>
            ...
            <div class="tab-pane fade {{ @$_GET['active-tab'] == 'custom-css' ? 'active show' : '' }}" id="tabs-5"
                ...
                <form action="{{ route('backend.admin.settings.website.custom.css.update') }}" method="post" class="ds-settings-card">
                    @csrf
                    <div class="ds-settings-card-header">
                        <h5>
            ...
            <div class="tab-pane fade {{ @$_GET['active-tab'] == 'website-status' ? 'active show' : '' }}"
                ...
                <form action="{{ route('backend.admin.settings.website.status.update') }}" method="post" class="ds-settings-card">
                    @csrf
                    <div class="ds-settings-card-header">
                        <h5>
            ...
            <div class="tab-pane fade {{ @$_GET['active-tab'] == 'invoice-settings' ? 'active show' : '' }}"
                ...
                <form action="{{ route('backend.admin.settings.website.invoice.update') }}" method="post" class="ds-settings-card">
                    @csrf
                    <div class="ds-settings-card-header">
                        <h5>
