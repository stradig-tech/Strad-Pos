...
<head>
    ...
    <title><?php echo e(readConfig('site_name') ?? 'StradPOS'); ?> - Modern Web-Based Point of Sale &amp; Business Management</title>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" href="<?php echo e(assetImage(readConfig('favicon_icon') ?? readConfig('site_logo'))); ?>" type="image/x-icon">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="#home" class="sp-brand">
                    <span class="sp-brand-text">
                        <?php echo e(readConfig('site_name') ?? 'StradPos'); ?>
                ...
                <div class="sp-nav-actions">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('backend.admin.dashboard')); ?>" class="sp-btn-nav-cta">
                            <i class="fas fa-gauge-high mr-1"></i> Dashboard
                        </a>
                        <a href="<?php echo e(route('logout')); ?>" class="sp-btn-nav-login">
                            <i class="fas fa-arrow-right-from-bracket"></i>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="sp-btn-nav-login">
                            <i class="fas fa-user-circle mr-1"></i> Sign In
                        </a>
                        <a href="<?php echo e(route('signup')); ?>" class="sp-btn-nav-cta">
            ...
            <div class="row align-items-center sp-hero-split-row">
                ...
                <div class="col-lg-6 sp-hero-left-content">
                    ...
                    <div class="sp-hero-action-buttons">
                        <a href="<?php echo e(route('signup')); ?>" class="sp-btn-expert">
                            Get Started Free
                        </a>
                            ...
                            <div class="sp-pos-terminal-monitor">
                                <div class="sp-pos-monitor-bezel">
                                    ...
                                    <div class="sp-pos-screen-window">
                                        <img src="<?php echo e(asset('ss/pos.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Live Cashier Checkout Screen" class="sp-pos-screen-img">
                        ...
                        <div class="sp-item-tablet">
                            <div class="sp-tablet-device">
                                ...
                                <div class="sp-tablet-screen">
                                    <img src="<?php echo e(asset('ss/sales.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Tablet Sales Management" class="sp-tablet-screen-img">
                        ...
                        <div class="sp-item-handheld">
                            <div class="sp-handheld-terminal">
                                ...
                                <div class="sp-handheld-screen">
                                    <img src="<?php echo e(asset('ss/pos_invoice.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Smart POS Handheld Invoice" class="sp-handheld-screen-img">
                                </div>
        ...
        <div class="container">
            ...
            <div class="sp-tab-content-panel active" id="tab-pos">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/pos.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos POS Screen" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div class="sp-tab-content-panel" id="tab-dashboard">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/dashboard.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Dashboard" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div class="sp-tab-content-panel" id="tab-receipt">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/pos_invoice.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos POS Thermal Receipt" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div class="sp-tab-content-panel" id="tab-invoice">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/sales.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Sales Invoice" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div class="sp-tab-content-panel" id="tab-products">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/product_list.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Product Management" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div class="sp-tab-content-panel" id="tab-purchase">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/product_purchase.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Supplier Purchases" loading="lazy">
                    </div>
                </div>
            </div>
            ...
            <div class="sp-tab-content-panel" id="tab-reports">
                <div class="sp-browser-window">
                    ...
                    <div class="sp-browser-content">
                        <img src="<?php echo e(asset('ss/sales_report.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Sales Reports" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="sp-browser-window">
                            ...
                            <div class="sp-browser-content">
                                <img src="<?php echo e(asset('ss/dashboard.png')); ?>?v=<?php echo e(time()); ?>" alt="StradPos Real-Time Analytics Dashboard" style="width: 100%; height: auto;">
                            </div>
                        </div>
                    </div>
            ...
            <div class="sp-hardware-banner">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 text-center">
                        <img src="<?php echo e(asset('assets/images/landing/smart-terminal.jpg')); ?>" alt="Smart POS Terminal" class="sp-hardware-img" style="max-height: 380px;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <?php if(session('contact_success')): ?>
                <div class="alert alert-success alert-dismissible fade show text-center mb-4" role="alert">
                    <i class="fas fa-circle-check me-2"></i> <?php echo e(session('contact_success')); ?>
                        ...
                        <div class="sp-contact-info-panel">
                            <div>
                                ...
                                <div class="sp-contact-info-item">
                                    ...
                                    <div class="sp-contact-text">
                                        ...
                                        <p><?php echo e(readConfig('contact_address') ?? 'Dhaka, Bangladesh'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="sp-contact-info-item">
                                    ...
                                    <div class="sp-contact-text">
                                        ...
                                        <p><?php echo e(readConfig('contact_phone') ?? '+1 (151) 373-7979'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="sp-contact-info-item">
                                    ...
                                    <div class="sp-contact-text">
                                        ...
                                        <p><?php echo e(readConfig('contact_email') ?? 'stradpos@gmail.com'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="sp-contact-info-item">
                                    ...
                                    <div class="sp-contact-text">
                                        ...
                                        <p><?php echo e(readConfig('working_hour') ?? 'Sun - Thu 10:30am - 07:00pm'); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-4 border-top border-white-50">
                                ...
                                <div class="d-flex gap-2">
                                    <?php if(readConfig('facebook_link')): ?>
                                        <a href="<?php echo e(readConfig('facebook_link')); ?>" target="_blank" class="sp-social-btn"><i class="fab fa-facebook-f"></i></a>
                                    <?php endif; ?>
                                    <?php if(readConfig('twitter_link')): ?>
                                        <a href="<?php echo e(readConfig('twitter_link')); ?>" target="_blank" class="sp-social-btn"><i class="fab fa-twitter"></i></a>
                                    <?php endif; ?>
                                    <?php if(readConfig('linkedin_link')): ?>
                                        <a href="<?php echo e(readConfig('linkedin_link')); ?>" target="_blank" class="sp-social-btn"><i class="fab fa-linkedin-in"></i></a>
                                    <?php endif; ?>
                                    <?php if(readConfig('whatsapp_link')): ?>
                                        <a href="<?php echo e(readConfig('whatsapp_link')); ?>" target="_blank" class="sp-social-btn"><i class="fab fa-whatsapp"></i></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="sp-footer">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-6 col-md-12">
                    <a href="#home" class="sp-footer-logo">
                        <span class="sp-footer-brand"><?php echo e(readConfig('site_name') ?? 'StradPOS'); ?></span>
                    </a>
                    ...
                    <div class="sp-footer-socials">
                        <a href="<?php echo e(readConfig('facebook_link') ?? '#'); ?>" class="sp-social-btn"><i class="fab fa-facebook-f"></i></a>
                        <a href="<?php echo e(readConfig('twitter_link') ?? '#'); ?>" class="sp-social-btn"><i class="fab fa-twitter"></i></a>
                        <a href="<?php echo e(readConfig('linkedin_link') ?? '#'); ?>" class="sp-social-btn"><i class="fab fa-linkedin-in"></i></a>
                        <a href="<?php echo e(readConfig('instagram_link') ?? '#'); ?>" class="sp-social-btn"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="sp-footer-bottom">
                <div>
                    <div>&copy; <?php echo e(date('Y')); ?> <strong><?php echo e(readConfig('site_name') ?? 'StradPos'); ?></strong>. All rights reserved.</div>
...
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\Mansib\Laravel- Web-project\StradPos\resources\views/frontend/home.blade.php ENDPATH**/ ?>