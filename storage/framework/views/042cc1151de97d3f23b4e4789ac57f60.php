...
<body>
    <div class="content">
        <img class="img-fluid" src="<?php echo e(asset('assets/images/404-error.jpg')); ?>" alt="">
            ...
            <g id="root" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <g id="Group" transform="translate(40.000000, 361.000000)">
                    <rect id="Rectangle-51" x="0" y="0" width="420" height="60"></rect><text
                        ...
                        <tspan x="12.022354125976562" y="52.5">StradPos</tspan>
                    </text>
                </g>
            </g>
        </svg>
...
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\Mansib\Laravel- Web-project\StradPos\resources\views/errors/404.blade.php ENDPATH**/ ?>