...
<head>
    ...
    <title>
        Sign Up | <?php echo e(readConfig('site_name')); ?>
    ...
    <section class="ds-split-auth-container">
        <div class="ds-auth-left" style="justify-content: flex-start; padding-top: 5rem;">
            ...
            <div class="image-content text-center mt-4">
                <img src="<?php echo e(asset('assets/images/authentication/register.png')); ?>" alt="Sign Up" style="max-width: 90%; height: auto;">
            </div>
        </div>
        ...
        <div class="ds-auth-right">
            <div class="ds-auth-form-container">
                ...
                <form action="<?php echo e(route('signup')); ?>" method="post" class="needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
                    
                    <div class="row g-3 mb-3">
                        <div class="col-sm-6">
                            <label for="firstName" class="ds-auth-label">First name</label>
                            <input type="text" class="form-control ds-auth-input" id="firstName" name="name" value="<?php echo e(old('name')); ?>" required>
                            <div class="invalid-feedback">Please enter your first name.</div>
                        </div>
                        <div class="col-sm-6">
                            <label for="lastName" class="ds-auth-label">Last name</label>
                            <!-- Note: Added for UI parity with design -->
                            <input type="text" class="form-control ds-auth-input" id="lastName" name="last_name" value="<?php echo e(old('last_name')); ?>">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="email" class="ds-auth-label">Email address</label>
                        <input type="email" class="form-control ds-auth-input" id="email" autocomplete="off" name="email" value="<?php echo e(old('email')); ?>" required>
                ...
                <div class="text-center mt-3" style="font-size: 0.9rem; color: #64748B;">
                    Already have an account ? <a href="<?php echo e(route('login')); ?>" style="color: #4F46E5; font-weight: 600; text-decoration: none;">Sign in</a>
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\Mansib\Laravel- Web-project\StradPos\resources\views/frontend/authentication/sign-up.blade.php ENDPATH**/ ?>